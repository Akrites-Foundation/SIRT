...
- a. The OSS-SIRT’s mission is to reduce systemic risk in open source software by providing a neutral, maintainer-respecting security incident response capability that validates vulnerability reports, coordinates remediation, enables responsible disclosure, and delivers trusted vulnerability data to the ecosystem.
