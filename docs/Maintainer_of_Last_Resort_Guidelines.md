...
- **EU Cyber Resilience Act: Akrites shall prepare to embrace the role of Steward for MoLR releases**.  *"Open-source software steward" is a recognized, bounded status under the CRA carrying lighter obligations than "manufacturer". The current [guidance by the European Commission](https://ec.europa.eu/newsroom/dae/redirection/document/131456) (page 23ff, also see flow-chart on page 29) indicates that a MoLR release triggers the Steward obligations for Akrites. Additionally, it would appear questionable for Akrites - a project dedicated to releasing secure software - to not adhere to the very lightweight obligations for Stewards defined in the CRA. And the obligations phase in through 2027. **Get counsel to opine before the first release ships, and record the answer here rather than leaving it to the first case.**
