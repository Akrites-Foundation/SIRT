...
If you tell us it isn't a vulnerability, or that it's just a bug, we treat that as the start of a conversation rather than the end of one. We'll send you the reproduction, the code path we think is reachable, and the deployment assumptions we made, and we'll ask what would change your mind. We'll take a call if you'd rather talk it through. **We might be the ones who are wrong**, and sometimes we are: you wrote the software and you know things about how it's used that we don't. If you convince us, we close the case, tell the reporter why, withdraw the CVE if one was reserved, and that's the end of it. We will not create an advisory or a write-up. 

If we feel that this is a vulnerability, and even after discussion, you do not, we will publish an advisory. You will be informed in advance of what we think, why we disagree, and the date we plan to publish the advisory. The date we plan to publish the advisory is not a bargaining chip used to push you into accepting our contribution, either. Our goal is to honor your position and contributions while continuing to be a trusted source of advice for users on security concerns that have met our standards for verification and remediation. We want to work with you in the future if we ever find another issue that we agree to remediate together, so expect us to show up in as partners now and in the future. 

Our standing offer to all maintainers is that we will offer to print your reasoning as to why the remediation was declined in the advisory word for word. It's going to describe your decision either way, and you're better placed than we are to explain it: that the configuration has been documented as unsupported for years, that the affected code path needs a flag nobody sets, or that you just don't agree with our assessment. Write it however you like, put your name on it or don't, and we'll show you the finished advisory before it goes out. If you prefer to not have your words in the advisory, please let us know. We will not include a statement from you. We will not repurpose words shared in private communications for the advisory without your approval. 
