...
If we still disagree after all that and proceed with an advisory, a CVE identifier will be assigned to document the issue for downstream security scanners. You'll hear that from us first: what we think, why, and the date. We won't spring it on you, we won't argue with you in public, and we won't call your decision negligent. We also won't hold a publication date over you to get a fix out of you, because the deadline isn't a bargaining chip.
